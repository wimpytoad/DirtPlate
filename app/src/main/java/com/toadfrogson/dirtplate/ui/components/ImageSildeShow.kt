package com.toadfrogson.dirtplate.ui.components
...
fun ImageSlideShow(imageUrls: List<String>) {
    ...
    val painter =
        rememberAsyncImagePainter(com.toadfrogson.dirtplate.ui.screen.getFullPosterUrl(selectedImageUrl), imageLoader = imageLoader)
    LaunchedEffect(Unit) {
        while (true) {
